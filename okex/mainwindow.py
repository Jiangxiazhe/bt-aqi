...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.order_start_time_timeEdit = QTimeEdit(self.monitor_tab)
        self.order_start_time_timeEdit.setObjectName(u"order_start_time_timeEdit")

        self.gridLayout_3.addWidget(self.order_start_time_timeEdit, 4, 1, 1, 1)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.order_start_time_timeEdit.setDisplayFormat(QCoreApplication.translate("mainWindow", u"H:mm:ss", None))
        ...
        self.best_lag_display_label.setText(QCoreApplication.translate("mainWindow", u"10 s", None))
        self.exch_time_label.setText(QCoreApplication.translate("mainWindow", u"\u4ea4\u6613\u6240\u65f6\u95f4", None))
        self.exch_time_display_label.setText(QCoreApplication.translate("mainWindow", u"09:00:00", None))
        ...
        self.label_3.setText(QCoreApplication.translate("mainWindow", u"\u7f51\u5740", None))
        self.label_4.setText(QCoreApplication.translate("mainWindow", u"APIKey", None))
        self.site_addr_lineEdit.setText(QCoreApplication.translate("mainWindow", u"https://www.okx.com/", None))
        self.secret_key_lineEdit.setText(QCoreApplication.translate("mainWindow", u"494EEE3588C90273529A89A6BCFC8C4E", None))
        self.api_key_lineEdit.setText(QCoreApplication.translate("mainWindow", u"dce6db0b-cebc-4df0-ae4b-74ca67ed6060", None))
        self.load_setting_pushButton.setText(QCoreApplication.translate("mainWindow", u"\u8bfb\u53d6(\u672a\u5b9e\u73b0)", None))
